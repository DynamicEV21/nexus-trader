# Nexus Trader Integration Map

> **Created:** 2026-05-31
> **Purpose:** Map all trading/quant repos to Nexus Trader integration opportunities
> **Context:** Nexus Trader is an AI trading harness built on LumiBot v4.5.25

---

## Executive Summary

Nexus Trader sits at the intersection of 8 quant projects. The integration strategy follows the **agentic-quant-os** master vision: unified lakehouse, memory bridge, and tool ecosystem.

**Highest priority integrations:**
1. **quant-loop-testnet** — Strategy Genome DB becomes Nexus Trader's persistent memory
...
| Priority | Repo | Integration | Effort | Impact |
|----------|------|-------------|--------|--------|
| **P3** | quant-12-agent-ts | Dashboard for Nexus Trader runs | Medium | Low |
...
### 1. agentic-quant-os → Nexus Trader
...
| Component | Nexus Trader Use | Integration Method |
|-----------|----------------|-------------------|
...
### 3. quant-loop-testnet → Nexus Trader
...
class GenomeBridge:
    ...
    def insert_ai_decision(self, decision: dict):
        """
        Insert an AI trading decision from Nexus Trader.
...
This becomes the **baseline strategy** for Nexus Trader. AI-generated strategies must beat RSI-Centered-Pivots in walk-forward to be considered for live deployment.

---

### 5. quant-pipeline → Nexus Trader
...
### 6. quant-12-agent-ts → Nexus Trader
...
| Component | Nexus Trader Use | Integration Method |
|-----------|----------------|-------------------|
| React UI | Dashboard for Nexus Trader runs | Extend or fork |
| factory.db | Read strategy results | SQLite connection |

**Low priority** — This is a visualization layer. Better to build Nexus Trader-specific dashboard or extend the agentic-quant-os Streamlit dashboard.

---

### 7. LobsterQuant → Nexus Trader
...
### 8. CrabQuant-agents → Nexus Trader
...
| Nexus Trader | `/home/Zev/development/nexus-trade/src/memory/` | Memory bridge (to build) |
| Nexus Trader | `/home/Zev/development/nexus-trade/src/tools/` | Custom tools (to build) |

---

*This integration map is the roadmap for building Nexus Trader. Start with the memory bridge (Week 1), then add custom tools (Week 2), then integrate data sources (Week 3), then test and iterate (Week 4).*